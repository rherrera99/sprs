...
<ul class="breadcrumb breadcrumb-top">
    ...
    <li><a href="<?php echo $this->Url->build(['controller' => 'Doctors', 'action' => 'index']); ?>">Manage Doctors</a></li>
    <li>Add Doctor</li>
</ul>
<div class="block">
    ...
    <div class="" id="add_doctor_form">
        <?php echo $this->Form->create($doctor, ['id' => 'form-validation', 'enctype' => 'multipart/form-data']); ?>
        ...
        <div class="row">
            <div class="col-xs-12 form-group" >
                <label for="" class="col-xs-3">Name(Don't use any keyword before name) : </label>
                <label for="" class="col-xs-1"><h4>Dr.</h4></label>
            ...
            <div class="col-xs-12 form-group">
                ...
                <div class="form-group col-xs-9">
                    ...
                    echo $this->Form->input('gender', [
                        'type' => 'radio',
                        'id' => 'gender',
                        'class' => 'form-control required col-xs-3 ',
                        'label' => false,
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                <label for="" class="col-xs-3">Designation</label>
                <div class="form-group col-xs-9">
                    <?php
        ...
        <div class="row">
            <div class="col-xs-12 form-group">
                <label for="" class="col-xs-3">Education</label>
                <div class="form-group col-xs-9">
                    <?php
                    echo $this->Form->input('education', [
                        ...
                        'rows' => 3,
                        'class' => 'form-control ',
                        'placeholder' => 'Enter education(coma[,] seperated)',
                        'label' => false
                    ]);
                    ?>
                </div>
        ...
        <div class="form-group">
            <div class="checkbox icheck">
                ...
                echo $this->Form->input('status', [
                    ...
                    'type' => 'checkbox',
                    'class' => 'form-control',
                    'label' => ['class' => 'no-padding', 'text' => ' <b>Active</b>', 'escape' => false]
                ]);
                ?>
            </div>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyClHcXgT1Q_ynPKBiGV7b93nFZJl0zSt6g&libraries=places"></script>
<script>
    $(function() {
        $('input').iCheck({
